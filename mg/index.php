        ...
        <div id="main" class="main_singlecard main_sell_singlecard game_mtg">
          ...
          <div class="card_list_box">
            ...
            <ul class="card_list">
              ...
              ?>
              <li class="card_unit rarity_M-foil">
                ...
                <div class="price_box">
                  <form action="../addCart.php" method="post">
                    ...
                    <input type="hidden" name="price" value="<?php echo $card_m_price[$i]; ?>" >
                    <input type="hidden" name="name" value="<?php echo $card_m_name[$i]; ?>" >
                    <input type="hidden" name="pic" value="<?php echo $card_m[$i]; ?>" >
                    ...
                    <p class="quantity">
                      <input type="number" name="quan" max=<?php echo $card_m_stock[$i]; ?> min=0 maxlength="2" size="2" style="width:98%!important;text-align: center; "/>
                    </p>
                    <p class="cart">
